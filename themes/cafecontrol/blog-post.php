...
<!--                    <!--facebook-->-->
<!--                    <div class="fb-share-button" data-href="--><?php //= $data->url; ?><!--" data-layout="button_count"-->
<!--                         data-size="large"-->
<!--                         data-mobile-iframe="true">-->
<!--                        <a target="_blank"-->
<!--                           href="https://www.facebook.com/sharer/sharer.php?u=--><?php //= urlencode($data->url); ?><!--"-->
<!--                           class="fb-xfbml-parse-ignore">Compartilhar</a>-->
<!--                    </div>-->
<!---->
<!--                    <!--twitter-->-->
<!--                    <a href="https://twitter.com/share?ref_src=site" class="twitter-share-button" data-size="large"-->
<!--                       data-text="--><?php //= $data->title; ?><!--" data-url="--><?php //= $data->url; ?><!--"-->
<!--                       data-via="--><?php //= str_replace("@", "", CONF_SOCIAL_TWITTER_CREATOR); ?><!--"-->
