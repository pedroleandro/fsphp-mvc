...
<head>
    <meta charset="UTF-8">
    <meta name="mit" content="2026-02-16T11:52:09-03:00+187017">
    ...
    <div class="container content">
        <section class="main_footer_content">
            ...
            <article class="main_footer_content_item social">
                <h2>Social:</h2>
                <a target="_blank" class="icon-facebook" href="https://facebook.com" title="CafeControl no Facebook">/CafeControl</a>
                <a target="_blank" class="icon-instagram" href="https://instagram.com" title="CafeControl no Instagram">@CafeControl</a>
                <a target="_blank" class="icon-youtube" href="https://youtube.com" title="CafeControl no YouTube">/CafeControl</a>
            </article>
        </section>
    </div>
</footer>
